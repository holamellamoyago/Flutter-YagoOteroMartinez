...
import 'package:english_mvvm_provider_clean/presentation/screens/game_screen/puntuation_screen/dialog_timer_widget.dart';
...
class ClockViewmodel extends ChangeNotifier {
  ...
  void openDialog(BuildContext context, bool isWin) {
    showDialog(
      ...
      context: context,
      builder: (context) =>  DialogTimerWidget(isWin: isWin,),
    );
  }
}
