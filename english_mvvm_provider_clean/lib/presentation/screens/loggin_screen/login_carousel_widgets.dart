...
import 'package:english_mvvm_provider_clean/presentation/screens/loggin_screen/auth_button_widget.dart';
...
class ButtonsLoginWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    UsersViewmodel dbProvider = Provider.of<UsersViewmodel>(
      context,
      listen: false,
    );
