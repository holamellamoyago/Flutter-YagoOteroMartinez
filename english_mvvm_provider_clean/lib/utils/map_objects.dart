...
Map<int, bool> mapLevelsCompleted(List<Map<String, dynamic>> data) {
  Map<int, bool> map = {};
  for (var i = 0; i < data.length; i++) {
    Map<String, dynamic> indivudualData = data[i];

    int levelID = indivudualData["level_id"];
    bool completed = indivudualData["completed"];

    map[levelID] = completed;
  }
